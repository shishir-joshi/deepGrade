...
flags.DEFINE_integer("class_number", 8, "Number of class in your dataset/label.txt, default is 3.")
flags.DEFINE_integer("image_height", 100, "Height of the output image after crop and resize. Default is 299.")
flags.DEFINE_integer("image_width", 100, "Width of the output image after crop and resize. Default is 299.")
